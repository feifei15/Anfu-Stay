...
export async function getHongKongStayQuote({ roomId, checkin, checkout }) {
...
export async function updateHongKongAdminCalendar({ action, start, end, roomId, rateUsd, note }) {
  await ensureSchema(); const sql = sqlClient();
  if (action === "block") {
