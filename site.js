const translations = {
  ...
  'Moonlit city view': '月色城市夜景', 'Evening skyline': '傍晚天际线',
  ...
  'Humidity': '湿度', 'On humid days, keep the windows closed. Use the white Westinghouse dehumidifier and empty it when full. The fan and both living-room air conditioners can also help control humidity.': '香港潮湿时请关好窗户，使用白色 Westinghouse 除湿机，并在水箱满时清空。风扇和客厅的两台空调也可帮助除湿。', 'Water heater location': '热水器位置', 'Dehumidifier location': '除湿机位置',
  'Trash': '垃圾', 'Place tied trash bags inside the bin in the stairwell, behind the door opposite the elevator. Trash is collected daily. If the bin is full, please do not leave bags outside it. Flatten all boxes before disposal.': '请将扎好的垃圾袋放入楼梯间内的垃圾桶，位置在电梯对面门的后方。垃圾每天清运；若垃圾桶已满，请勿将垃圾袋留在桶外。纸箱须拆平后再丢弃。', 'Trash bin location': '垃圾桶位置',
